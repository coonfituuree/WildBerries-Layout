    ...
    <header className={cn("bg-[#231d30]", className)}>
      <Container className="flex items-center justify-between py-4 md:py-6 px-4 ">
        <div className="flex items-center justify-center gap-4">
          <Image src="/wb_logo.jpg" alt="Logo" width={58} height={58} className="rounded-2xl"/>
          <div className="text-xl text-zinc-200">WildBerries</div>
        </div>

        <div>
            <input type="text" placeholder="Найти на Wildberries" className="bg-white outline-none rounded-xl w-[924px] h-[58px] px-6" />
        </div>
